...
<head>
    ...
    <title>修改用户名</title>
    <base target="_parent">
    <link rel="stylesheet" type="text/css" href="<%=basePath%>static/css/changeName.css"/>
...
<div class="add">
    <form id="editForm" action="<%=basePath%>changename?method=changeName" method="post">
        <input type="hidden" name="userphone" value="${user.userphone}"/>
        <input type="hidden" name="oldName" id="oldName" value="${user.username}"/>
        <table class="tableadd">
            <tr>
                <td>用户昵称：</td>
                <td style="color:red;">
                    <input type="text" id="newName" name="newName" value="${user.username}"/>
                </td>
            </tr>
            <tr>
                <td colspan="4" align="left">
                    <!--  location.href='<%=basePath%>student?method=list'-->
                    <button class="return" type="button" onclick="window.history.back(-1)">
                        <!-- <i class="fa fa-edit"></i> -->
                        <svg t="1640306541406" class="icon" viewBox="0 0 1024 1024" version="1.1"
                             xmlns="http://www.w3.org/2000/svg" p-id="9460" width="15" height="15">
                            <path d="M512.034377 0a512 512 0 0 1 296.813714 929.206857l-87.113142-117.540571a365.714286 365.714286 0 1 0-426.569143-5.12l84.041143-109.348572L512.034377 1024H128.034377l77.970286-101.595429-10.971429-8.338285A512 512 0 0 1 512.034377 0z"
                                  p-id="9461" fill="#fff">
                            </path>
                        </svg>
                        返回
                    ...
                    <button class="submit" type="submit">
                        ...
                        <svg t="1640306784805" class="icon" viewBox="0 0 1024 1024" version="1.1"
                             xmlns="http://www.w3.org/2000/svg" p-id="11020" width="15" height="15">
...
<%--%>--%>
<%--<script type="text/javascript">--%>
<%--    var change = document.getElementById('newName');--%>
