...
@WebFilter(urlPatterns= {"/*"},initParams= {
		@WebInitParam(name="exclude",value="/login.jsp,/Login,/login,/register.jsp,/Register,/error.html,/noprivilige.html,.css,.png,.jpg,.js")
})
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
		...
		if(isExist(uri) || uri.equals(httpServletRequest.getContextPath()+"/")) {
			...
			if(user != null) {
				...
				httpServletResponse.sendRedirect("page/error/noprivilige.html");
			}
		}
	}
